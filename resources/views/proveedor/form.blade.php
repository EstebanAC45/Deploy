...
<label for="nombre_proveedor">Nombre completo</label><br>
    ...
    <input type="text" class="form-control" name="direccion"pattern="^[a-zA-Z0-9áéíóúÁÉÍÓÚ, ]+$" title="Por favor ingrese al menos 3 caracteres, ya sean letras o números." required value="{{ isset($proveedor->direccion)?$proveedor->direccion:''}}" required><br>
