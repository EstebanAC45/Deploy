...
<form id="agregarElCliente" action="{{ url ('/cliente') }}" method="post">
    ...
    <input type="text" name="nombres" id="nombres" class="form-control" value=""  pattern="^[a-zA-ZáéíóúÁÉÍÓÚ]{3,254}$" title="Solo se permiten un mínimo de 3 letras, no números" required><br>
    <label for="apellidos">{{'Apellidos'}}</label><br>
    <input type="text" name="apellidos" id="apellidos" class="form-control" value=""  pattern="^[a-zA-ZáéíóúÁÉÍÓÚ]{3,254}$" title="Solo se permiten un mínimo de 3 letras, no números" required><br>
    ...
    <input type="number" name="compras_realizadas" id="compras_realizadas" class="form-control" value="0" required><br>
